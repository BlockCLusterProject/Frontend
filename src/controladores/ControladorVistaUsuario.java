...
public class ControladorVistaUsuario {
	...
	private Pelicula p1 = new Pelicula("gogogo", 120, 6.6, "dfkj", "/img/terminator_2.jpg");
	private Pelicula p2 = new Pelicula("Terminator 2", 137, 8.6,
	...
	private Pelicula p3 = new Pelicula("p3", 3, 3.3, "3", "/img/terminator_2.jpg");
	private Pelicula p4 = new Pelicula("p4", 4, 4.4, "4", "/img/terminator_2.jpg");
	private Pelicula p5 = new Pelicula("p5", 5, 5.5, "5", "/img/terminator_2.jpg");
	private Pelicula p6 = new Pelicula("p6", 6, 6.6, "6", "/img/terminator_2.jpg");
